...
'slug' => 'area',
        ...
        'restricted_terms' => array(
            ...
            \MapasCulturais\i::__('Cooperação Cultural'),
            \MapasCulturais\i::__('Cultura Cigana'),
            \MapasCulturais\i::__('Cultura Comunitária'),
            ...
            \MapasCulturais\i::__('Povos Originários'),
    ...
    3 => array(
        ...
        'restricted_terms' => array(
            ...
            \MapasCulturais\i::__('Rádio'),
            \MapasCulturais\i::__('Teatro'),
            \MapasCulturais\i::__('Encontro de Comunidades Indígenas'),
            \MapasCulturais\i::__('Encontro de Comunidades Afrodescendentes'),
            \MapasCulturais\i::__('Encontro de Cultura Jovem'),
            \MapasCulturais\i::__('Encontro de Cultura em Rede e Colaborativa'),
            \MapasCulturais\i::__('Meios Alternativos e Comunitários'),
            \MapasCulturais\i::__('Encontro de Participação Cidadã e Políticas Públicas'),
            \MapasCulturais\i::__('Sustentabilidade e Bem Viver'),
            \MapasCulturais\i::__('Feira de Produções da Cultura Comunitária'),
            \MapasCulturais\i::__('Encontro de Comunidades'),
            \MapasCulturais\i::__('Encontro de Diversidade Sexual'),
            \MapasCulturais\i::__('Outros')
        )
    )
);
